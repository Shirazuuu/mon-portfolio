      ...
      <div className="hero-content">
        ...
        <motion.div className="text-container" initial="hidden" animate="visible" variants={{hidden:{},visible:{transition:{staggerChildren:0.2}}}}>
          ...
          <motion.div className="hero-buttons" variants={{hidden:{opacity:0,y:20},visible:{opacity:1,y:0}}} transition={{delay:0.8}}>
            <a href="#contact" className="btn contact-btn" aria-label="Me Contacter"><FaEnvelope className="icon"/> Me Contacter</a>
            <a href="/ProCV.pdf" download="ProCV.pdf" className="btn download-btn" aria-label="Télécharger le CV"><FaDownload className="icon"/> Télécharger le CV</a>
          </motion.div>
        </motion.div>
      </div>
    </section>
